...
var author$project$Cell$DayAndNight = 1;
var author$project$Cell$Flock = 2;
var author$project$Cell$HighLife = 3;
var author$project$Cell$LongLife = 4;
var author$project$Cell$Maze = 5;
var author$project$Cell$Move = 6;
var author$project$Cell$Seeds = 7;
...
var author$project$Cell$resolveInDayAndNight = F2(
	function (cell, numOfAliveNeighbors) {
		return cell ? (A2(
			elm$core$List$member,
			numOfAliveNeighbors,
			_List_fromArray(
				[3, 4, 6, 7, 8])) ? true : false) : (A2(
			elm$core$List$member,
			numOfAliveNeighbors,
			_List_fromArray(
				[3, 6, 7, 8])) ? true : false);
	});
var author$project$Cell$resolveInFlock = F2(
	function (cell, numOfAliveNeighbors) {
		return cell ? (A2(
			elm$core$List$member,
			numOfAliveNeighbors,
...
var author$project$Cell$resolveInHighLife = F2(
	function (cell, numOfAliveNeighbors) {
		return cell ? (A2(
			elm$core$List$member,
			numOfAliveNeighbors,
...
var author$project$Cell$resolveInLife = F2(
	function (cell, numOfAliveNeighbors) {
		return cell ? (A2(
			elm$core$List$member,
			numOfAliveNeighbors,
...
var author$project$Cell$resolveInLongLife = F2(
	function (cell, numOfAliveNeighbors) {
		return cell ? (A2(
			elm$core$List$member,
			numOfAliveNeighbors,
...
var author$project$Cell$resolveInMaze = F2(
	function (cell, numOfAliveNeighbors) {
		return cell ? (A2(
			elm$core$List$member,
			numOfAliveNeighbors,
			_List_fromArray(
				[1, 2, 3, 4, 5])) ? true : false) : (A2(
			elm$core$List$member,
			numOfAliveNeighbors,
			_List_fromArray(
				[3])) ? true : false);
	});
var author$project$Cell$resolveInMove = F2(
	function (cell, numOfAliveNeighbors) {
		return cell ? (A2(
			elm$core$List$member,
			numOfAliveNeighbors,
...
var author$project$Cell$resolveInSeeds = F2(
	function (cell, numOfAliveNeighbors) {
		return cell ? false : (A2(
			elm$core$List$member,
			numOfAliveNeighbors,
			_List_fromArray(
				[2])) ? true : false);
...
var author$project$Cell$resolveCell = F5(
	function (position, cell, length, cells, rule) {
		...
		var numOfAliveNeighbors = elm$core$List$sum(
			A2(
				...
				A2(
					elm$core$List$map,
					function (neighborsPosition) {
						return A2(author$project$Cell$isCellAlive, neighborsPosition, cells);
					},
					neighborsPositions)));
		return (!rule) ? A2(author$project$Cell$resolveInLife, cell, numOfAliveNeighbors) : ((rule === 1) ? A2(author$project$Cell$resolveInDayAndNight, cell, numOfAliveNeighbors) : ((rule === 2) ? A2(author$project$Cell$resolveInFlock, cell, numOfAliveNeighbors) : ((rule === 3) ? A2(author$project$Cell$resolveInHighLife, cell, numOfAliveNeighbors) : ((rule === 4) ? A2(author$project$Cell$resolveInLongLife, cell, numOfAliveNeighbors) : ((rule === 5) ? A2(author$project$Cell$resolveInMaze, cell, numOfAliveNeighbors) : ((rule === 6) ? A2(author$project$Cell$resolveInMove, cell, numOfAliveNeighbors) : ((rule === 7) ? A2(author$project$Cell$resolveInSeeds, cell, numOfAliveNeighbors) : A2(author$project$Cell$resolveInLife, cell, numOfAliveNeighbors))))))));
	});
...
var author$project$Cell$resolve = F3(
	function (length, cells, rule) {
		return A2(
...
var author$project$Cell$TwoXTwo = 8;
var author$project$Cell$ruleFromString = function (rule) {
...
var author$project$Cell$ruleToString = function (rule) {
	switch (rule) {
		case 0:
			return 'Life';
		case 1:
...
var author$project$Main$toSvg = F4(
	function (coordinates, cell, cellLook, colorScheme) {
		return A2(
			elm$svg$Svg$rect,
			_List_fromArray(
				[
...
var author$project$Main$toggleSettings = function (isSettingsCollapsed) {
	return isSettingsCollapsed ? ' collapsed' : '';
};
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$Attributes$class('menu btn-group')
							]),
						_List_fromArray(
							[
								A2(
						...
						_List_fromArray(
							[
								elm$html$Html$Attributes$class('menu-right')
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										elm$html$Html$Attributes$class('btn btn-secondary toggle-settings'),
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$class('generation')
					]),
				_List_fromArray(
					[
