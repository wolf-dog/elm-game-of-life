module Cell exposing (Cell, Cells, Coordinates, Rule(..), resolve, ruleFromString, ruleToString)
...
resolveInLife cell numOfAliveNeighbors =
    ...
    else if List.member numOfAliveNeighbors [ 3 ] then
        True
...
resolveInTwoXTwo cell numOfAliveNeighbors =
    ...
    else if List.member numOfAliveNeighbors [ 3, 6 ] then
        True
...
resolveInDayAndNight cell numOfAliveNeighbors =
    ...
    else if List.member numOfAliveNeighbors [ 3, 6, 7, 8 ] then
        True
...
resolveInLongLife cell numOfAliveNeighbors =
    ...
    else if List.member numOfAliveNeighbors [ 3, 4, 5 ] then
        True
...
resolveInMove cell numOfAliveNeighbors =
    ...
    else if List.member numOfAliveNeighbors [ 3, 6, 8 ] then
        True
...
resolveInSeeds cell numOfAliveNeighbors =
    ...
    else if List.member numOfAliveNeighbors [ 2 ] then
        True
